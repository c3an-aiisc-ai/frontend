      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3">
          ...
          >
            ...
            <p className="mt-3 text-[11px] text-slate-600">Collect results and specify final format.</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white/90 p-4 shadow-sm">
          ...
          <textarea
            ...
            onChange={(e) => onAgentJsonChange(e.target.value)}
            spellCheck={false}
          />
          {agentParseError && <p className="mt-2 text-xs font-semibold text-rose-600">{agentParseError}</p>}
