...
export const AGENT_PRESETS: AgentPreset[] = [
  ...
  },
  {
    id: "fanout",
    name: "Fan-out",
    description: "Broadcast to three",
    inputCount: 1,
    outputCount: 3,
  },
  {
  ...
  },
  {
    id: "triage",
    name: "Triage",
    description: "Route with fallback",
    inputCount: 1,
    outputCount: 4,
  },
  {
    id: "analysis",
    name: "Analysis",
    description: "Ingest two, emit two",
    inputCount: 2,
    outputCount: 2,
  },
  {
...
export const TOOL_PALETTE: ToolPreset[] = [
  {
    name: "Lumen Trace",
    tagline: "Quick spotlight",
  ...
  },
  {
    ...
    outputCount: 2,
    inputRequired: [false],
    outputRequired: [false, false],
  },
  {
    name: "Echo Loom",
    tagline: "Thread replies",
  ...
  {
    name: "Polar Kite",
    tagline: "Flow navigator",
    gradient: "from-blue-50 via-white to-sky-100",
    ring: "ring-blue-200",
    accent: "bg-blue-600",
    inputCount: 2,
    outputCount: 2,
  ...
  {
    name: "Cipher Lens",
    tagline: "Inspect payloads",
    gradient: "from-violet-50 via-white to-indigo-100",
    ring: "ring-violet-200",
    accent: "bg-indigo-600",
    inputCount: 1,
    outputCount: 3,
    inputRequired: [true],
    outputRequired: [true, false, false],
  },
  {
    name: "Vapor Prism",
    tagline: "Soft preview",
    gradient: "from-lime-50 via-white to-emerald-100",
    ring: "ring-lime-200",
    accent: "bg-lime-600",
    inputCount: 1,
    outputCount: 1,
...
export const ACCEPTED_FILE_TYPES =
  ".pdf,.csv,.xlsx,.xls,.json,.txt,.doc,.docx,.xml,.zip";
