...
export default function App() {
  const { containerRef, transform, setTransform, reset } = zoom({
  ...
  return ( 
    <div className = "h-screen w-screen bg-slate-50"> 
	  ...
	  <div className="mt-4">
	    <button 
	      className="px-3 py-2 rounded by-blue-600 text-white"
	      onClick={() => setTransform({ x:0, y:0, zoom: 1 })}> Reset View </button>
	    </div>
          </aside>

	  <main className="flex-1 relative">
	    <div ref={containerRef as any} className="absolute inset-0">
